...
return (
    ...
    <div className="md:hidden absolute z-10 flex items-center gap-5 flex-col p-4 w-full">
        {/* Dark Mode Button */}
        <button className="bg-white text-white rounded-full flex justify-center items-center self-end w-10 h-10">
        ...
        <label htmlFor="mobileSearch" className="flex justify-center gap-1 bg-white rounded-3xl w-full max-w-md p-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
            ...
            <input type="text" name="Search" id="mobileSearch" placeholder="San Francisco"  className="bg-red outline-transparent outline-0 w-24 focus:w-full focus:placeholder:opacity-50 placeholder:text-black transition-all ease-in"/>
        </label>
    </div>
